...
admin.site.site_header = "CTC"
admin.site.site_title = "CTC Admin Portal"
admin.site.index_title = "CTC Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="CTC API",
        default_version="v1",
        description="API documentation for CTC App",
    ),
    public=True,
